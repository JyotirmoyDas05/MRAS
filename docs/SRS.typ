...
#align(center)[
  ...
  #text(size: 11pt)[
    Version: 1.2 #h(2em) Date: 07-05-2026 \
...
- Prof. Rajib Mall, _Fundamentals of Software Engineering_ (SRS organisation and requirement types).
...
#figure(image("/assets/Architecture-diagram.excalidraw.svg", width: 100%), caption: [Architecture Diagram])
...
= Web-Based Architecture Diagrams (For Report)
...
#figure(image("/assets/context-diagram.excalidraw.svg", width: 100%), caption: [Context Diagram])
...
#figure(image("/assets/High-Architecture-diagram.excalidraw.svg", width: 100%), caption: [High-Level Web Architecture Diagram])
...
#figure(image("/assets/use-case-diagram.excalidraw.svg", width: 60%), caption: [Use-case Diagram])


= Goals of Implementation (Non-binding)
